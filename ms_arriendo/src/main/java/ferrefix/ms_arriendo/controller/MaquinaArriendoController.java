...
import ferrefix.ms_arriendo.assembler.MaquinaArriendoAssembler;
...
public class MaquinaArriendoController {
    ...
    private final MaquinaArriendoAssembler maquinaArriendoAssembler;
    ...
    public ResponseEntity<CollectionModel<EntityModel<MaquinaResponseDTO>>> listarTodas() {
        ...
        CollectionModel<EntityModel<MaquinaResponseDTO>> collection = maquinaArriendoAssembler.toCollectionModel(maquinas)
                .add(linkTo(methodOn(MaquinaArriendoController.class).listarTodas()).withSelfRel());
    ...
    public ResponseEntity<EntityModel<MaquinaResponseDTO>> registrar(@Valid @RequestBody MaquinaRequestDTO dto) {
        ...
        EntityModel<MaquinaResponseDTO> model = maquinaArriendoAssembler.toModel(registrada);
    ...
    public ResponseEntity<EntityModel<MaquinaResponseDTO>> arrendar(
        ...
        EntityModel<MaquinaResponseDTO> model = maquinaArriendoAssembler.toModel(arrendada);
    ...
    public ResponseEntity<EntityModel<MaquinaResponseDTO>> devolver(@PathVariable Integer idEquipo) {
        ...
        EntityModel<MaquinaResponseDTO> model = maquinaArriendoAssembler.toModel(devuelta);
