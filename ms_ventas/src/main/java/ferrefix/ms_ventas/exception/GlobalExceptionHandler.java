...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleTypeMismatch(
        ...
        String mensaje = String.format("El parámetro '%s' recibió '%s', se esperaba tipo: %s.",
    ...
    // 500 Error interno (Puede que no se hizo bien la conexion)
    ...
    // Asistente de respuesta, body mas entendible para el usuario
